...
const fixturesDeployment = async () => {
  ...
  const randoms = await ethers.getContractFactory("XRandoms");
  ...
  const randomizer = await ethers.getContractFactory("RandomizerNXT");
  ...
  const nextGenMinter = await ethers.getContractFactory("MinterContract");
